...
- **[정답] Defects that escape testing and are detected in a live environment** 
...
- **[정답] 4 weeks** 
- $$ \text{평균 속도}= {29 + 30 + 31 \over 3} = 30 \text{ points per iteration} $$
- $$ \text{작업 완료 소요 기간 : } {60 \text{ points} \over 30 \text{ points per iteration}} = 2 \text{ iteratoins} $$
- $$ \text{배포 소요 시간 = 2 iterations x 2 weeks per iteration = 4 weeks } $$
...
**[정답] The metric that indicates what is likely to happen in the future** 
...
- **[정답] This may lead to points inflation, not more work completed.** 
...
- **[정답] When stakeholders attempt to compare velocity across teams** 
...
- **[정답] Employee net promoter score** 
...
- **[정답] Explain that tracking defects at the team level encourages team members to collaborate and help each other.** 
...
- **[정답] To reduce the collection effort and the likelihood of gaming the metric** 
...
- **[정답] It allows the team to assess the process efficiency of a workflow.** 
...
- **[정답] User stories accepted and earned value** 
...
- **[정답] Develop a set of corporate, department, and project goals as well as associated measurement goals for productivity and quality** 
...
- **[정답] Progress and issues relating to the product or service being created** 
...
- **[정답] Make project metrics available on the team portal** 
...
- **[정답] The tendency for overt measurement to influence behavior** 
...
- **[정답] Team performance and team well-being** 
...
- **[정답] They are simple but fast-paced metrics that engage teams in their creation and measurement ** 
...
- **[정답] Metrics and rewards can bring about unintended side effects** 
...
- **[정답] Team metrics evolve quickly, program metrics evolve at a medium pace, portfolio metrics evolve slowly** 
...
- **[정답] Metrics provide a way to track progress and give early warning signs of issues** 
