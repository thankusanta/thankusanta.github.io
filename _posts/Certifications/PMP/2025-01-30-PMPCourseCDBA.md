...
- **[정답] C. Promoting the CD initiative throughout the organization through events, training, and presentations** 
...
- **[정답] D. All of the above** 
  
</div>
</details>

### 5. For organizations that are hierarchical in nature and implementing a CD Competency Center, their governance may include:
...
- **[정답] D. Formal role descriptions, budget, and training agreed to upfront** 
...
- **[정답] D. Ensure the impact of CD has visibility within the organization, and celebrate success** 
...
- **[정답]  B. Measure of CD's effect on Shadow IT** 
...
- **[정답] A. Engage them early in the process to discuss their ideas and incorporate their input where appropriate.** 
...
- **[정답] A. Report on metrics that demonstrate the benefits and effectiveness of the citizen development strategy** 
...
- **[정답] A. Time to value, Revenue, Cost, Brand, Customer, Employee** 
...
- **[정답] A. Implement practices to support the handoff's** 
...
- **[정답] A. It can result in significant productivity improvements and operational savings.** 
...
- **[정답] A. Regular dialogues should occur among the citizen developer team, IT, and the competency center.** 
...
- **[정답] A. To use citizen development to solve a local problem in a way that will yield quantifiable value** 
...
- **[정답] A. Incorporate citizen development processes, value and performance measurements, appropriate KPI's and process automation** 
...
- **[정답] A. Facilitate team-building exercises such as informal gatherings and lunch-and-learn sessions** 
...
- **[정답] A. Ways of working, organizational processes, and structures that characterize the stages of citizen development maturity** 
...
- **[정답] A. To define the KPI's that will be used and the process for their measurement** 
...
- **[정답] A. The organization can prove that the value created by citizen developoment is repeatable and scalable.** 
...
- **[정답] A. By empowering a citizen developer to own a larger portion of the process, freeing resources in project management and IT oversight** 
...
- **[정답] A. The sales team could develop the new app using a low-code/no-code platform so that the app would not be placed on the IT backlog.** 
...
- **[정답] A. Facilitate and coordinate maintenance and support resources from IT** 
...
- **[정답] A. Establishing governance around citizen development activities becomes more critical.** 
...
- **[정답] A. It can yield significant productivity improvements and operational savings.** 
...
- **[정답] A. Establishing goverance around citizen development activities and having a centralized view of the value being delivered** 
...
- **[정답] A. Suggest squad members with sufficient business and technical capabilities to deliver the project** 
...
- **[정답] A. Create standardized processes and best practices for the citizen developer practitioners to follow** 
...
- **[정답] A. Supporting and learning from other team members is a common practice and cultural norm.** 
