...
- **[정답] It is simply more pragmatic to use universal terms when spanning such a wide arc of practices.**
- **[정답] It is a leading hybrid approach that uses practices and techniques from agile, lean, and traditional ways of working.** 
- **[정답] It demonstrates that DA is impartial and does not have a preference for one method of working over another**
...
- **[정답] Provide continuous feedback to the team as work progresses.** 
- **[정답] Ensure any problems are quickly dealt with so the team can stay focused on their work.**
- **[정답] Act as the voice of the customer, representing all of their requirements and needs, and conveying them back to the team.**
- **[정답] Clarify any details about which the team may be uncertain.**
- **[정답] Ensure all work is completed as expected.**
...
- **[정답] Employs leadership skills, facilitating communication, and empowering team members to self-organize.**
- **[정답] Keeps distractions to a minimum, allowing everyone else to focus on delivering the iteration work.**
- **[정답] Removes any barriers, and ensures the team has the necessary resources to deliver their work.**
- **[정답] Acts as host, creating and maintaining the conditions that enable agile teams to succeed.**
</div>
</details>
...
- **[정답] Test products and prototypes, plus other forms of quality assurance.**[
- **[정답] Do the hands-on work of completing the tasks in a scrum iteration.**[
- **[정답] Use data to find best practices for development.**[
- **[정답] Help in iteration planning and goal setting.**[
</div>
</details>
...
- **[정답] Allows the product owner to swap items around when new requirements and feedback are provided.**
- **[정답] Enables teams to be more nimble, flexible and adaptable, and quickly respond to any last-minute changes.**
- **[정답] Allows you to visualize the work ranked from highest priority to lowest.**
...
- **[정답] A write-up of a user request, written in a concise format from the user's point of view.**
- **[정답] The most efficient way of capturing any user requirements.**
- **[정답] A small (actually, the smallest) piece of work that represents some value to an end user and can be delivered during ann iteration.**
...
- **[정답] Work item must have enough details that the team has no more immediate questions.**
- **[정답] Work item must be small enough to be done in one iteration.**
- **[정답] Work item must be estimated.**
</div>
</details>
...
- **[정답] Takes the queswork out of how much work to put into the iteration backlog.**
- **[정답] Helps the product owner estimate the project completion date.**
...
- **[정답] Promotes visibility to see where the team is in the specific iteration.**
- **[정답] Facilitates and promotes conversation and interaction.**
- **[정답] Improves the ability of a team to manage with interdependencies by coordinating their efforts.**
- **[정답] Prevents scope creep.**
- **[정답] Supports transparency and teamwork.**
</div>
</details>
...
- **[정답] The vertical axis shows the sum of remaining story points in the iteration.**
- **[정답] A burndown chart is a graphical representation of the work remaining and the time remaining to complete it.**
- **[정답] The horizontal axis shows the number of days in the iteration.**
- **[정답] A bunrndown chart is commonly usred while working in short iterations.**
...
- **[정답] External impediment ** 
  - Budget Approval
  - Power Outage
  - Organizational Culture
- **[정답] Internal impediment ** 
  - Team Member Issues
  - Confusion About User Story
  - Insufficient Skill Sets
...
- **[정답] A list of 3-5 requirements that must be met before a task is marked as completed and moved to the "done" column.**[
- **[정답] It is often a mix of organizational quality standards and the team's own quality standards.**[
- **[정답] The method in which work completion is defined.**[
- **[정답] A user story task that is completed when the product owner reviews and confirms that it meets the end user requiredments.**[
...
- **[정답] What have you learned from this iteratons?**
- **[정답] What went well in the iteration?**
- **[정답] What still puzzles us about the way we work together?**
- **[정답] What can we improve in the next iteratoin?**
...
3. Iteration Backlog
4. Iteration
5. Daily Coordination Meeting
6. Consumable Solution
7. Iteration review
